...
def generate(file_font, font_size, chars, destfolder):
  ...
  for c in chars:
    ...
    # New approach using getbbox():
    left1, top1, right1, bottom1 = font.getbbox(c)
    left2, top2, right2, bottom2 = font.getbbox(c + c)

    width_c  = right1 - left1
    width_cc = right2 - left2
    advance_width = width_cc - width_c
